`include "inv_mix_col.sv"

module InvMixColumns (
  input logic [127:0] inv_mixColumns_in,
  output logic [127:0] after_inv_mixColumns
);
    logic [31:0] col15, col14, col13, col12;
    logic [31:0] after_col15, after_col14, after_col13, after_col12;
