`include "decipher_mul.sv"
module inv_mix_col (
    input logic [31:0] inv_mixColumns_in, 
    output logic [31:0] after_inv_mixColumns
);
   
    logic [7:0] byte15; 
    assign byte15 = inv_mixColumns_in[31:24]; 
    logic [7:0] byte14; 
    assign byte14 = inv_mixColumns_in[23:16];
    logic [7:0] byte13; 
    assign byte13 = inv_mixColumns_in[15:8];  
    logic [7:0] byte12; 
    assign byte12 = inv_mixColumns_in[7:0];   

    
    logic [7:0] byte15_mul2, byte15_mul4, byte15_mul8;
    logic [7:0] byte14_mul2, byte14_mul4, byte14_mul8;
    logic [7:0] byte13_mul2, byte13_mul4, byte13_mul8;
    logic [7:0] byte12_mul2, byte12_mul4, byte12_mul8;

    logic [7:0] byte15_mul0e, byte15_mul0b, byte15_mul0d, byte15_mul09;
    logic [7:0] byte14_mul0e, byte14_mul0b, byte14_mul0d, byte14_mul09;
    logic [7:0] byte13_mul0e, byte13_mul0b, byte13_mul0d, byte13_mul09;
    logic [7:0] byte12_mul0e, byte12_mul0b, byte12_mul0d, byte12_mul09;
