`include "mul.sv"
module mixCol(
  input logic [31:0] mixColumn_in,
  output logic [31:0] after_mixColumn
);
  logic [7:0] byte15_mul2,byte15_mul3;
  logic [7:0] byte14_mul2,byte14_mul3;
  logic [7:0] byte13_mul2,byte13_mul3;
  logic [7:0] byte12_mul2,byte12_mul3;
