...
module AES_Cipher_Core(
  ...
  logic [127:0] subBytes_sel,after_subBytes;
  ...
  // SubBytes - Sbox
  //------------------------------------------------------------------------
  SubBytes u_subbytes(.subBytes_sel(subBytes_sel),.after_subBytes(after_subBytes));
  //------------------------------------------------------------------------
  // ShiftRows - Actual is a rotate
  //------------------------------------------------------------------------
  ShiftRows u_shiftrows(.after_subBytes(after_subBytes),.after_shiftRows(after_shiftRows));
  //----------------------------------------------------------------------------
