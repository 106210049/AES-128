...
module inv_mix_col (
    ...
    mul mul15(.inv_mixColumns_in(byte15), .mul2_out(byte15_mul2), .mul4_out(byte15_mul4), .mul8_out(byte15_mul8));
    mul mul14(.inv_mixColumns_in(byte14), .mul2_out(byte14_mul2), .mul4_out(byte14_mul4), .mul8_out(byte14_mul8));
    mul mul13(.inv_mixColumns_in(byte13), .mul2_out(byte13_mul2), .mul4_out(byte13_mul4), .mul8_out(byte13_mul8));
    mul mul12(.inv_mixColumns_in(byte12), .mul2_out(byte12_mul2), .mul4_out(byte12_mul4), .mul8_out(byte12_mul8));
